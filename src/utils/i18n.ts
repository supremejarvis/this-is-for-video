...
export const TRANSLATIONS = {
  en: {
    ...
    prepaidDesc: 'Zero handling charge • Fast Express dispatch',
    ...
    speedPostFreight: 'Express Logistics Base Freight',
    ...
    shippingProvenanceLive: 'Live Express Delivery Rate',
  ...
  gu: {
    ...
    prepaidDesc: 'કોઈ હેન્ડલિંગ ચાર્જ નહીં • એક્સપ્રેસ ડિલિવરી ઝડપી રવાનગી',
    ...
    speedPostFreight: 'એક્સપ્રેસ ડિલિવરી મૂળ નૂર',
    ...
    shippingProvenanceLive: 'લાઇવ એક્સપ્રેસ ડિલિવરી દર',
  ...
  hi: {
    ...
    prepaidDesc: 'शून्य हैंडलिंग शुल्क • एक्सप्रेस प्राथमिकता डिलीवरी',
    ...
    speedPostFreight: 'एक्सप्रेस डिलीवरी मूल भाड़ा',
    ...
    quoteId: 'कोट संख्या',
    quoteValidUntil: 'कोट वैधता समय',
    quoteExpired: 'कोट की अवधि समाप्त',
    quoteStale: 'कार्ट या पिन बदला गया है। दरें सत्यापित करने के लिए पुनर्गणना करें।',
    ...
    shippingProvenanceLive: 'लाइव एक्सप्रेस डिलीवरी दर',
