    ...
    variants: [
      {
        ...
        b2cPrice: 20,
        b2bTierPricing: [
          { minQty: 1, maxQty: 999, pricePerUnit: 17, discountPercent: 15 },
          { minQty: 1000, maxQty: 2499, pricePerUnit: 15, discountPercent: 25 },
...
export const AUTHENTIC_CATALOG_DEFAULTS = MOCK_PRODUCTS;
